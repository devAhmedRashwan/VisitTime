            ...
            override fun onDataChange(p0: DataSnapshot) {
                ...
                try {
                    ...
                    for (n in p0.children) {
                        ...
                        val searchcontext = book.patname.toString() + book.patphone.toString() + book.patname.toString()
                        if (btnswitch.isChecked &&searchtext.text.isEmpty()) btnswitch.isChecked=false
